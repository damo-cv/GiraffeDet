...
model = dict(
    ...
    neck=dict(
        ...
        fpn_config=None,
        fpn_name=None,
        fpn_channels=[128, 160, 224, 352, 768],
        ...
        feature_info=[dict(num_chs=192, reduction=8), dict(num_chs=384, reduction=16), dict(num_chs=768, reduction=32)],
...
optimizer = dict(
   ...
   weight_decay=0.0005,
   nesterov=True,
   paramwise_cfg=dict(bias_lr_mult=0., bias_decay_mult=0.))


# learning policy
lr_config = dict(warmup_ratio=0.1, step=[267, 291])
# lr_config = dict(policy='CosineAnnealing', warmup='linear', warnup_iters=1000, warmup_ratio=0.1, min_lr_ratio=0.2)
total_epochs = 300
